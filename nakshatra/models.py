...
class College_registration(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    college = db.Column(db.String(120), unique=True, nullable=False)
    leader_name = db.Column(db.String(120), nullable=False)
    leader_email = db.Column(db.String(120), unique=True, nullable=False)
    part_1_name = db.Column(db.String(120), nullable=False)
    part_1_email = db.Column(db.String(120), nullable=False)
    part_2_name = db.Column(db.String(120), nullable=False)
    part_2_email = db.Column(db.String(120), nullable=False)
    part_3_name = db.Column(db.String(120), nullable=False)
    part_3_email = db.Column(db.String(120), nullable=False)
    part_4_name = db.Column(db.String(120), nullable=False)
    part_4_email = db.Column(db.String(120), nullable=False)